...
export const handleEventStatistics = () => {
  ...
  document.querySelector(".huy-button-statistic-revenue").addEventListener("click", () => {
    // let tmpMonthPicker = document.querySelector(".huy-input-month").value.split("-");
    console.log(document.querySelector(".huy-input-year").value);
  });
}